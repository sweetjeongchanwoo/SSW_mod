...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1950.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NProduction = {
	...
	LICENSE_IC_COST_YEAR_INCREASE = 1,					-- IC cost equipment for every year of equipment after 
...
NAI = {
	...
	RT_TRAINING_EQUIPMENT_LEVEL = 0.9,               -- ai will not start to train if equipment drops below this level
