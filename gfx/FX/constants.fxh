...
static const float SPECULAR_MULTIPLIER			= 0.5;
...
static const float TERRAIN_TILE_FREQ 			= 120.0f;
...
static const float GB_CAM_MIN = 10.0f;
static const float GB_CAM_MAX = 50.0f;
...
static const float GB_THRESHOLD2 = 0.5f; // interpolation time
...
static const float GB_OPACITY_FAR = 0.75f;  // Transparency when camera is far
...
static const float GB_STRENGTH_CH1 = 1.32; // Opacity of bottom layer
static const float GB_STRENGTH_CH2 = 1.32; // Opacity of top layer
